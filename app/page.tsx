...
const blogs = [
  {
    title: "How I Built a Handwriting-to-Font Pipeline for My Diary App",
    url: "https://medium.com/@mbbairagii/how-i-built-a-handwriting-to-font-pipeline-for-my-diary-app-d4dca795e2b0",
    tags: ["Dev", "Project"],
    desc: "A deep dive into building an OCR-powered pipeline that converts your real handwriting into a usable font — inside a diary app.",
    date: "Apr",
  },
  {
    title: "Why People Betray Their Own Potential",
    url: "https://medium.com/@mbbairagii/why-people-betray-their-own-potential-c4d8cfb6d6ff",
    tags: ["Essay", "Philosophy"],
    desc: "A question I keep coming back to — why do people sabotage themselves before anyone else gets the chance to?",
    date: "Apr",
  },
  {
        ...
        <header className="fixed inset-x-0 top-0 z-40 dark:bg-d-bg/90 bg-l-bg/90 backdrop-blur-md dark:border-b dark:border-d-border border-b border-l-border">
          <nav className="mx-auto flex max-w-5xl items-center justify-between px-4 md:px-6 py-3.5">
            ...
            <div className="flex items-center gap-3">
              <div className="relative h-8 w-8 overflow-hidden rounded-full dark:border dark:border-d-border border border-l-border">
                <Image src="/main1.png" alt="Mohini" fill className="object-cover object-top" />
              </div>
        ...
        <main className="mx-auto max-w-5xl px-4 md:px-6 pb-0 pt-16 md:pt-20 space-y-4">
            ...
            <div className="flex items-start justify-between gap-6 md:gap-8">
              <div className="flex flex-col gap-4 flex-1 min-w-0">
                ...
                <div>
                  ...
                  <p className="mt-2 md:mt-3 font-display text-lg md:text-2xl font-bold dark:text-zinc-400 text-zinc-600 leading-snug">
                ...
                <div className="flex flex-wrap gap-2 pt-1">
                  {socials.map((s) => (
                    <a key={s.l} href={s.h}
                      ...
                      className="flex items-center gap-1.5 rounded-full dark:border dark:border-d-border border border-l-border px-3 md:px-4 py-1.5 font-mono text-[11px] md:text-xs dark:text-zinc-400 text-zinc-600 transition-colors dark:hover:border-d-accent dark:hover:text-d-accent dark:hover:bg-white/10 hover:border-l-accent hover:text-l-accent hover:bg-black/5">
                      {s.l} ↗
                    </a>
                  ))}
                </div>
              ...
              <div className="shrink-0">
                <div className="relative h-[200px] w-[160px] md:h-[320px] md:w-[250px] overflow-hidden rounded-2xl dark:border dark:border-d-border border border-l-border shadow-lg">
                  <Image src="/main1.png" alt="Mohini" fill className="object-cover object-top" priority />
          ...
          <footer className="pt-2 pb-0">
            <div className="flex items-center justify-between border-t dark:border-d-border border-l-border py-5 px-1">
              <p className="font-mono text-xs dark:text-zinc-500 text-zinc-400">
                mohini · 2026
              </p>
              <div className="flex items-center gap-4 md:gap-5 flex-wrap justify-end">
                {socials.map((s) => (
                  <a key={s.l} href={s.h}
                    target={s.h.startsWith("mailto") ? undefined : "_blank"}
                    rel="noopener noreferrer"
                    className="font-mono text-[10px] md:text-[11px] dark:text-zinc-400 text-zinc-500 transition-colors dark:hover:text-white hover:text-zinc-900">
                    {s.l}
                  </a>
                ))}
              </div>
            ...
            <div className="overflow-hidden -mx-4 md:-mx-6 pb-0">
              <p
                className="font-display font-bold leading-none tracking-tighter whitespace-nowrap text-center select-none dark:text-white/[0.06] text-black/[0.07]"
